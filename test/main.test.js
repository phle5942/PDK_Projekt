...
// });
//
var filePath = "./small_set.csv";
var input = [1, 2];
var expectedResult = [[3, 7.07], [4, 7.07]];
test('small dataset', function () { return __awaiter(void 0, void 0, void 0, function () {
    var result, i;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, main_1.main)(input, filePath, 2)];
            case 1:
                result = _a.sent();
                expect(result.length).toBe(expectedResult.length);
                for (i = 0; i < expectedResult.length; i = i + 1) {
