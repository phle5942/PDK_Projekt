    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var stream = fs_1.default.createReadStream("ml-latest-small/movies.csv")
                        .pipe((0, csv_parser_1.default)())
                        .on("data", function (row) {
                        var title = String(row.movie_title);
                        if (title.toLowerCase().replace(/[^a-zA-Z0-9åäö]/gi, "").includes(movie_name.toLowerCase().replace(/[^a-zA-Z0-9åäö]/gi, "")) ||
                            ...
                            var id = Number(row.movie_id);
                            var genres = String(row.movie_genres);
