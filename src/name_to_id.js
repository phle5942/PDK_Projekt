...
function name_to_id(movie_name) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve) {
                    var stream = fs.createReadStream("../ml-latest/movies.csv")
                        ...
                        if (title.toLowerCase().replace(/[^a-zA-Z0-9åäö]/gi, "").includes(movie_name.toLowerCase().replace(/[^a-zA-Z0-9åäö]/gi, "")) ||
                            ...
                            var id = Number(row.movieId);
                            var genres = String(row.genres);
                            var result_movie = { movie_id: id, movie_title: title, movie_genres: genres };
                            stream.destroy();
